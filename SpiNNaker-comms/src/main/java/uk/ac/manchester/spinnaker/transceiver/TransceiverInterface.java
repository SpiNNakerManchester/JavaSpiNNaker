...
public interface TransceiverInterface extends BMPTransceiverInterface {
	...
	/**
	 * Write data to memory on a chip using the Fast data protocol.  It is
	 * assumed that the protocol has been set up to run before this is called.
	 *
	 * @param gathererCore
	 *     The core to which data is written.
	 * @param ethernetChip
	 ...
	 * @param baseAddress
	 *     The address at which to start writing
	 * @param data
	 *     The data to write
	 ...
	 */
	void writeMemoryFast(
			@Valid CoreLocation gathererCore, @Valid ChipLocation ethernetChip,
			@NotNull String ethernetAddress, @Valid IPTag iptag,
