...
import uk.ac.manchester.spinnaker.messages.scp.BigDataInfo;
...
public interface TransceiverInterface {
    ...
    */
    ...
    /**
    * Set up Big Data transfer using the sender as the receiver.
    *
    * @param chip The chip to set up the transfer on.
    * @param core The core that will receive Big Data.
    *
    * @throws IOException
    *             If anything goes wrong with networking.
    * @throws ProcessException
    ...
    */
    @ParallelSafe
    void initialiseBigData(HasChipLocation chip, int core)
            throws IOException, ProcessException;

    /**
     * Set up Big Data transfer using a specific target.
     *
     * @param chip The chip to set up the transfer on.
     * @param core The core that will receive Big Data.
     * @param port The port that will receive Big Data.
     * @param ipAddress The IP Address that will receive Big Data.
     *
     * @throws IOException
     *             If anything goes wrong with networking.
     * @throws ProcessException
     ...
     */
    @ParallelSafe
    void initialiseBigData(HasChipLocation chip, int core, int port,
            InetAddress ipAddress) throws IOException, ProcessException;

    /**
     * End Big Data transfer.
     *
     * @param chip The chip to end the transfer on.
     *
     * @throws IOException
     *             If anything goes wrong with networking.
     * @throws ProcessException
     ...
     */
    @ParallelSafe
    void freeBigData(HasChipLocation chip) throws IOException, ProcessException;

    /**
     * Get information about Big Data transfer.
     *
     * @param chip The chip to get information from.
     * @return Information about Big Data transfer.
     *
     * @throws IOException
     *             If anything goes wrong with networking.
     * @throws ProcessException
     ...
     */
    @ParallelSafe
    BigDataInfo.Response getBigDataInfo(HasChipLocation chip)
            throws IOException, ProcessException;
