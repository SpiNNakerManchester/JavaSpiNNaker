...
public class ProgressBar implements Closeable {
	...
	/**
	 * The space between 0% and 50% is the mid-point minus the width of 0% and
	 * ~half the width of 50%.
	 */
    private static final int LEFT_SPACES = MAX_LENGTH_IN_CHARS / 2 - 4;

	/**
	 * The space between 50% and 100% is the mid-point minus the rest of the
	 * width of 50% and the width of 100%.
	 */
