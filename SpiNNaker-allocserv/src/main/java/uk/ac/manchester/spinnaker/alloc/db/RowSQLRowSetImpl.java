...
import static uk.ac.manchester.spinnaker.alloc.db.DatabaseEngineJDBCImpl.columnNames;
...
public final class RowSQLRowSetImpl implements Row {
	...
	RowSQLRowSetImpl(SqlRowSet rs, String sql) {
		this.rs = rs;
		this.sql = sql;
	}
	...
	public byte[] getBytes(String columnLabel) {
		return get(() -> rs.getString(columnLabel).getBytes());
	}
