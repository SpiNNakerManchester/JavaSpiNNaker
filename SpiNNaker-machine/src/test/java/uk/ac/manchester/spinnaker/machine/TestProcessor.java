...
public class TestProcessor {
	...
	public void testComparesTo() {
		...
		Processor standard =
				Processor.factory(1, MachineDefaults.PROCESSOR_CLOCK_SPEED,
						MachineDefaults.DTCM_AVAILABLE, false);
		Processor two =
				Processor.factory(2, MachineDefaults.PROCESSOR_CLOCK_SPEED,
						MachineDefaults.DTCM_AVAILABLE, false);
		Processor monitor =
				Processor.factory(1, MachineDefaults.PROCESSOR_CLOCK_SPEED,
	...
	public void testBad() {
		assertThrows(IllegalArgumentException.class, () -> {
			Processor bad = Processor.factory(1, -10,
					MachineDefaults.DTCM_AVAILABLE, false);
		});
		assertThrows(IllegalArgumentException.class, () -> {
			Processor bad = Processor.factory(1,
