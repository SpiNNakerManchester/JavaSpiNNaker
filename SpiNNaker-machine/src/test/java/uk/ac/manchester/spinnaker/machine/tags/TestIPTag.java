...
public class TestIPTag {
    ...
    public void testBasic() throws UnknownHostException {
        ...
        String trafficIdentifier = "Donald Duck";
    ...
    public void testEquals() throws UnknownHostException {
        IPTag tag1 = new IPTag(
                ...
                createInetAddress((byte)55), 20, true, "Donald Duck");
        ...
        testNotEquals(tag1, new IPTag(
                createInetAddress((byte)45), new ChipLocation(3, 3), 10,
                createInetAddress((byte)56), 20, true, "Donald Duck"));
        testNotEquals(tag1, new IPTag(
                createInetAddress((byte)45), new ChipLocation(3, 3), 10,
                createInetAddress((byte)55), 21, true, "Donald Duck"));
        testNotEquals(tag1, new IPTag(
                createInetAddress((byte)45), new ChipLocation(3, 3), 10,
                createInetAddress((byte)55), 20, false, "Donald Duck"));
        testNotEquals(tag1, new IPTag(
                createInetAddress((byte)45), new ChipLocation(3, 3), 10,
                createInetAddress((byte)55), 20, true, "Mickey"));
